		...
		<div class="row">
			<div class="col-md-12">
				<div class="card insurence-card ins-option">
					<div class="card-header d-block" align="center"><h5>Choose Insurance Service</h5></div>
					...
					<div class="card-body card-scrollbar">
						...
						<div class="card service-card pt-1" style="background-color: #FFCC00;  box-shadow: 0px 0px 5px 0px;">
						<div class="media-body ml-3 d-flex">
						<h5 class="pl-3">First Party: Includes Car and Motorcycle</h5>
						
	</div>
						<div class="media-body ml-3 d-flex">
						<h5 class="pl-3">Second Party: Only Car</h5>
	</div>
						<div class="media-body ml-3 d-flex">
						<h5 class="pl-3">Third Party: Only Motorcycle</h5>
	</div>
						</div>
						</div>
					...
					<div class="card-footer d-block" align="right">
						<button class="btn btn-warning px-4"><a href="Recharge.php">Payment</a></button>
					</div>
				</div>
			</div>
		</div>
