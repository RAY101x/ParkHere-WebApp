...
<body>
        ...
        <div class="row my-4">
          ...
          <div class="col-md-6 mt-5">
            <div class="mt-4 text-center ">
              <h2 class="reqTitle text-success">Request Parking</h2>
	...
	<div class="form-group">
		...
		<input class="form-control" id="local" name="local" type="text" placeholder="Enter Your locality" required="">
		</select>
	</div>

	<div class="form-group">
		<label>Required Parking Location</label>
		<input class="form-control"  id="parkingloc" name="parkingloc" type="text" placeholder="Enter location" required="">
	</div>
	...
	<div class="modal fade" id="confirm_modal">
		...
		<div class="modal-content">
			...
			<button  class="btn btn-warning px-4" name='request_parking'>Confirm</button>
