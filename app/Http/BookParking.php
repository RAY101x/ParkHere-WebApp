	    ...
	    <div class="col-md-6">
          ...
          <div class="col-md-6 mt-5">
            <div class="mt-4 text-center ">
              <h2 class="reqTitle text-success">Parking Booking</h2>
            </div>
           </div>
          </div>
...
<div class="form-group">
 ...
 <div class="form-group">
	 <label> Vehicle Details and Time </label>
	 <input class="form-control" id="vehtyp" name="vehtyp" type="text" placeholder="Enter Details" required="">
 </div>
