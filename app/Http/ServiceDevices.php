		...
		<div class="row">
			<div class="col-md-12">
				<div class="card insurence-card ins-option">
					<div class="card-header d-block" align="center"><h5>Choose Product</h5></div>
					...
					<div class="card-body card-scrollbar">
						...
						<div class="card service-card">
							<div class="card-body">
								<div class="media">
									<div class="">
										<img src="assets/img/bikelock.jpg" class="service-img ">
									</div>
									<div class="media-body ml-3 d-flex">
										<a href="Recharge.php">Bike Locker</a>
										<!-- data-toggle="modal" data-target="#fclass-car-modal" -->
									</div>
						...
						<div class="card service-card">
							<div class="card-body">
								<div class="media">
									<div class="">
										<img src="assets/img/carlock.jpg" class="service-img ">
									</div>
									<div class="media-body ml-3 d-flex">
										<a href="Recharge.php">Car Locker</a>
										<!-- data-toggle="modal" data-target="#fclass-car-modal" -->
									</div>
									<span class="media-icon-last"><i class="fas fa-angle-right"></i></span>
								</div>
					...
					<!-- <div class="card-footer d-block" align="right">
						<button class="btn btn-warning px-4">Next >></button>
					</div> -->
				</div>
			</div>
		</div>
