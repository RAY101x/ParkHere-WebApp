...
<body>
	...
	<div class="container contact-form">
		<div class="row">
			<div class="col-md-12">
				<section class="complete_req_form mt-4">
	<div class="container-fluid">
		<div class="row">
			<div class="col-12">
				<form action="Recharge.php" method="post">
					...
					<div class="form-group">
						<label>Mobile:</label>
						 <input pattern="[0][1][0-9]{9}" maxlength="11" type="text" placeholder="01*********" name="mobile" id="mobile" class="form-control" required>
					</div>

					<div class="form-group">
						<label>Amount:</label>
						 <input maxlength="11" type="number" value="3500" name="amount" id="amount" min="350" class="form-control" required>
					</div>

					<!-- <div class="container repair_button_section"> -->
						<div class="row">
							<div class="col-12">
